...
[![Go Reference](https://pkg.go.dev/badge/github.com/payko-com/go-openai-pyk.svg)](https://pkg.go.dev/github.com/payko-com/go-openai-pyk)
[![Go Report Card](https://goreportcard.com/badge/github.com/payko-com/go-openai-pyk)](https://goreportcard.com/report/github.com/payko-com/go-openai-pyk)
[![codecov](https://codecov.io/gh/payko-com/go-openai-pyk/branch/master/graph/badge.svg?token=bCbIfHLIsW)](https://codecov.io/gh/payko-com/go-openai-pyk)
...
```
go get github.com/payko-com/go-openai-pyk
```

Currently, go-openai-pyk requires Go version 1.18 or greater.
...
See also: https://pkg.go.dev/github.com/payko-com/go-openai-pyk#ClientConfig
...
**Related Issues:**  
[omitempty option of request struct will generate incorrect request when parameter is 0.](https://github.com/payko-com/go-openai-pyk/issues/9)
...
**Related Issues:**  
[Is it possible to join the implementation of GPT3 Tokenizer](https://github.com/payko-com/go-openai-pyk/issues/62)

## Contributing

By following [Contributing Guidelines](https://github.com/payko-com/go-openai-pyk/blob/master/CONTRIBUTING.md), we hope to ensure that your contributions are made smoothly and efficiently.

## Thank you

We want to take a moment to express our deepest gratitude to the [contributors](https://github.com/payko-com/go-openai-pyk/graphs/contributors) and sponsors of this project:
